# Generated by Django 4.1 on 2024-07-26 22:23
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="appUsers.RecipeIngredient", to="appUsers.ingredient"
            ),
        ),
        migrations.CreateModel(
            name="MealPlan",
            fields=[
                ...
                ("recipes", models.ManyToManyField(to="appUsers.recipe")),
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
